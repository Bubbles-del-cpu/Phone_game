...
{
    public static class UIElementKeys
    {
        public static string UI_ELEMENTS_TABLE_KEY = "UI Elements";
        public static string YES = "dialog_button_yes";
        public static string NO = "dialog_button_no";
        public static string CLOSE = "dialog_button_close";
        public static string CONTINUE = "dialog_button_continue";
        public static string TRY_AGAIN = "dialog_button_try_again";
    }
