...
namespace MeetAndTalk.Nodes
{
    public class BaseNode : Node
    {
        ...
        public void TextFieldRegisterLangCallback(TextField field, List<LanguageGeneric<string>> lang)
        {
            if (field == null || lang == null)
                return;
            ...
            try
            {
                ...
                {
                    lang.Find(language => language.languageEnum == editorWindow.LanguageEnum).LanguageGenericType = value.newValue;
                });

                field.SetValueWithoutNotify(lang.Find(language => language.languageEnum == editorWindow.LanguageEnum).LanguageGenericType);
            }
            catch (Exception) { }
        }
    }
